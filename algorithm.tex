...
\section{A Bidirectional Algorithm for Linear Systems}
...
Additionally, $w_{V_iV_{i+1}} = sign(Q_{V^iV^j})||Q_i||_1 $ and by definition $||Q_i||_1  \leq ||Q||_{\infty}$. Also note $| \mathbf{b}[V^k] |\leq ||\mathbf{b}||_\infty$.
...
\subsection{Bidirectional Linear System Estimator}
