...
Previous work has looked at estimating a single component of a matrix equation through varying methods. 
One class of methods builds graph like sparsifiers for estimating single solution components \cite{spielman2014nearly, koutis2011nearly}. $\cite{koustis2011nearly}$ constructs a spanning tree of the graph implied by the linear system to efficiently 
