...
The problem of estimating $\pzlt$ has gained a lot of attention in recent times in the context of estimating random-walk transition probabilities, in particular, for estimating PageRank, Personalized PageRank, and other related network centrality metrics. 
